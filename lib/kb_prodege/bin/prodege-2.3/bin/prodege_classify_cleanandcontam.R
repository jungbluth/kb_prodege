...
n=data.frame(V1=paste(data.frame(do.call("rbind", strsplit(as.character(n$V1),"_",fixed=TRUE)))[,1],data.frame(do.call("rbind", strsplit(as.character(n$V1),"_",fixed=TRUE)))[,2],sep="_"))
